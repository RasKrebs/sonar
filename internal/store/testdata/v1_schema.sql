-- Frozen copy of the schema as shipped by migration 001, used to prove that a
-- database created by an older sonar migrates forward. Do not "fix" this file
-- when 001 changes: the point is that it is what is on old users' disks.
